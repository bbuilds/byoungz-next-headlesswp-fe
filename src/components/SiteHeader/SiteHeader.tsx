...
export function SiteHeader({ globalNavigation }: SiteHeaderProps) {
  ...
  return (
    <header
      ...
      className="sticky top-0 z-50 flex items-center border-b border-b-grey-300 bg-grey-100 px-[2vw] py-2 dark:border-b-grey-600 dark:bg-black lg:py-0 print:hidden"
    >
      <SmartLink href="/" classNames="flex items-center lg:mr-8">
        <span className="sr-only">
          Link to homepage of BYOUNGZ Digital Nomad
        </span>
        <LogoText className="h-8 w-auto fill-verdunGreen dark:fill-swampGreen" />
      </SmartLink>
