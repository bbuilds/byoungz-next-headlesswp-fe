...
export function SiteFooter() {
  return (
    <footer
      ...
      className="bg-grey-100 py-8 text-sm dark:bg-grey-500"
    >
      <div className="mx-auto max-w-5xl px-4">
        <div className="lg:flex lg:items-end  lg:justify-between">
          <div className="mb-8 text-center lg:mb-0 lg:text-left">
            <SmartLink href="/" classNames="text-white">
              <LogoText className="mx-auto mb-4 size-auto max-w-[10.9375rem] fill-verdunGreen dark:fill-swampGreen md:ml-0" />
          ...
          <div className="text-center lg:w-1/4 lg:text-left">
            <div className="mb-4 flex justify-center gap-x-2 lg:justify-end">
              <SmartLink href={SOCIAL_MEDIA_URLS.FACEBOOK}>
                <FacebookIcon className="h-auto w-10 fill-verdunGreen dark:fill-swampGreen" />
                <span className="sr-only">Link to Byoungz Facebook</span>
              </SmartLink>
              <SmartLink
                href={SOCIAL_MEDIA_URLS.INSTAGRAM}
                classNames="text-verdunGreen dark:text-swampGreen"
              >
                <InstagramIcon className="h-auto w-10" />
