...
import { RecentPostsSection } from "@/src/components";
...
describe("RecentPostsSection", () => {
  test("renders a RecentPostsSection component", () => {
    const { getByText, container } = render(
      <RecentPostsSection posts={posts} title="Recent posts" />,
    );
    expect(container.querySelectorAll("li").length).toBe(3);
    expect(getByText("Recent posts")).toBeTruthy();
  });
