...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Home Page -- Template&quot; was set to Show in GraphQL. */
  homePageTemplate?: Maybe<Page_Homepagetemplate>;
...
/** Field Group */
export type Page_Homepagetemplate = AcfFieldGroup & {
  __typename?: 'Page_Homepagetemplate';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  homeAboutContent?: Maybe<Scalars['String']['output']>;
  homeAboutImage?: Maybe<MediaItem>;
  homeFeaturedPost?: Maybe<Page_Homepagetemplate_HomeFeaturedPost>;
  homeIgTitle?: Maybe<Scalars['String']['output']>;
  homePoetryTitle?: Maybe<Scalars['String']['output']>;
  homeRecentBlogTitle?: Maybe<Scalars['String']['output']>;
  homeSecondaryPosts?: Maybe<Array<Maybe<PostObjectUnion>>>;
};

export type Page_Homepagetemplate_HomeFeaturedPost = Post;
...
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & {
  ...
  /** The excerpt of the post. */
  excerpt?: Maybe<Scalars['String']['output']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Extra Post Items&quot; was set to Show in GraphQL. */
  extraPostItems?: Maybe<Post_Extrapostitems>;
  /** Connection between the NodeWithFeaturedImage type and the MediaItem type */
  featuredImage?: Maybe<NodeWithFeaturedImageToMediaItemConnectionEdge>;
  /** The database identifier for the featured image node assigned to the content node */
  featuredImageDatabaseId?: Maybe<Scalars['Int']['output']>;
  ...
  /** URLs queued to be pinged. */
  toPing?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Travel Journal&quot; was set to Show in GraphQL. */
  travelJournal?: Maybe<Post_Traveljournal>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']['output']>;
};
...
/** Field Group */
export type Post_Extrapostitems = AcfFieldGroup & {
  __typename?: 'Post_Extrapostitems';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  frontPageTitle?: Maybe<Scalars['String']['output']>;
  useToc?: Maybe<Scalars['Boolean']['output']>;
};

/** Field Group */
export type Post_Traveljournal = AcfFieldGroup & {
  __typename?: 'Post_Traveljournal';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
